...
export const dossierCards: readonly DossierCard[] = [
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "Повеление Артаксеркса вступило в силу осенью 457 года до Р. Х. Отсчитав с этого момента 483 года, мы получим осень 27 года после Р. Х. — тогда-то и исполнилось это пророчество.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
      ...
      },
      {
        ...
        "quoteRu": "Осенью 27 года Христос был крещен Иоанном и помазан Духом Святым.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "В течение этого времени — с 27 по 34 год — Иисус вначале Сам, а затем и Его ученики проповедовали Евангелие исключительно для иудеев.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Семьдесят седмин, или 490 лет, которые были особо определены для иудеев, окончились, как мы видим, в 34 году по Р. Х. В это время решением иудейского синедриона народ запечатлел свое отвержение Евангелия, побив Стефана камнями и начав гонения на последователей Христа.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "Но в действительности эта ложь родилась в папском дворце в Риме.",
        "enKey": "But in fact",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "К этому его побуждало духовенство, которое, стремясь к славе и власти, понимало, что почитание одного и того же дня язычниками и христианами поможет язычникам формально принять христианство, что в свою очередь будет способствовать усилению могущества церкви.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "В указанное время Турция через своих послов приняла покровительство союзных держав Европы и подпала под зависимость и контроль христианских народов.",
        "enKey": "At the very time specified",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
    ...
    "claims": [
      {
        ...
        "quoteRu": "Но спустя три с половиной года это же собрание вновь возвратило свободу читать Слово Божье.",
        "enKey": "Three years and a half later",
        "asWritten": "discredited",
        "weakened": "well-supported",
        "gap": 4,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Иисус Христос был объявлен обманщиком, и лозунгом французских безбожников стали слова: «Свергнем негодяя» (имелся в виду Христос).",
        "enKey": "the rallying cry of the French infidels",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Его легкомысленный и эгоистичный ответ: «После меня хоть потоп!» как нельзя лучше определял участь, ожидавшую Францию.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "В то время как иудеи, оставившие город, погнались за отступающими войсками Цестия, и обе армии были захвачены сражением, христиане получили возможность уйти из города.",
        "enKey": null,
        "asWritten": "genuinely-open",
        "weakened": "well-supported",
        "gap": 2,
    ...
    "claims": [
      {
        ...
        "quoteRu": "Политика Рима была направлена на то, чтобы под маской благоговейного отношения к Библии держать ее под замком неизвестного народу языка и таким путем скрывать от людей.",
        "enKey": "It had been Rome's policy",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Рим скрывал Библию от народа и вместо нее навязывал людям свои доктрины. Благодаря Реформации человеку было возвращено Слово Божье, но разве современные церкви не учат людей основываться на символах веры и преданиях Церкви вместо Священного Писания?",
        "enKey": "Rome withheld the Bible from the people",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Папские руководители выбирают из Библии места, наилучшим образом отвечающие их намерениям, истолковывают их по своему усмотрению и затем преподносят народу, лишая его преимущества самостоятельно изучать Библию и постигать ее священные истины.",
        "enKey": "The papal leaders",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Им не разрешают свободно изучать Слово Божье, и потому им неведома истина.",
        "enKey": "They are not allowed access to His word",
        "asWritten": "discredited",
        "weakened": "well-supported",
        "gap": 4,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Рим постарался уничтожить всякий след своего жестокого обращения с раскольниками. Папские соборы постановили предать огню все книги и материалы, содержащие записи о преследованиях.",
        "enKey": "every record of her cruelty",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
    ...
    "claims": [
      {
        ...
        "quoteRu": "Они приняли ее от Рима, так же как и ложную субботу.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Теория о бессмертии души принадлежит к одному из тех лжеучений, какие Рим, переняв от язычников, внедрил в христианскую религию.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "Хотя идолопоклонники и объявили себя обращенными христианами, но они по-прежнему придерживались своих языческих обычаев, с той только разницей, что заменили предметы прежнего поклонения на образ Иисуса, Его матери и других святых.",
        "enKey": "only changing the objects of their worship",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "С виду побежденное язычество оказалось победителем. Его дух овладел церковью.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Для того чтобы облегчить в какой-то степени обращение язычников в христианство и чем-то восполнить их прежний ритуал идолослужения, в христианское богослужение постепенно было введено поклонение иконам и «святым мощам».",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Так была подготовлена почва для принятия другого языческого вымысла — идеи чистилища, с помощью которой Рим внушал страх легковерной и суеверной толпе.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
    ...
    "claims": [
      {
        ...
        "quoteRu": "Принципы, которыми руководствовались Григорий VII и Иннокентий III, по-прежнему остаются принципами Римско-католической церкви.",
        "enKey": "still",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Паписты заявляют: «Не следует выполнять обещания, данные еретикам и лицам, подозреваемым в ереси».",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Людей учили, что папа является посредником между Богом и человеком, и никто не может приблизиться к Богу, как только через него; и что папа для них вместо Бога, поэтому все должны безоговорочно подчиняться ему.",
        "enKey": "none could approach God except through him",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "В складках одежды они носили искусно спрятанные рукописи Священного Писания — свое величайшее сокровище.",
        "enKey": "greatest treasure",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Таким образом многие обращались в этих учебных заведениях, и часто случалось, что принципы истины распространялись по всему университету, и, несмотря на бдительность, папские руководители так и не могли добраться до первоначального источника «еретического учения», как они называли его.",
        "enKey": "frequently",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Приученные верить, что спасение можно получить через дела, собственными силами, люди все время смотрели на себя. Размышляя о своих грехах и страшась гнева Божьего, они изнуряли душу и тело, но не находили покоя. Вот так искренние души были опутаны доктринами Рима.",
        "enKey": null,
        "asWritten": "genuinely-open",
        "weakened": "probable",
        "gap": 1,
    ...
    "claims": [
      {
        ...
        "quoteRu": "На протяжении первых 2500 лет истории человечества не существовало письменного откровения.",
        "enKey": "no written revelation",
        "asWritten": "discredited",
        "weakened": "well-supported",
        "gap": 4,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Записывать Слово начали во времена Моисея.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "genuinely-open",
        "gap": 1,
      ...
      },
      {
        ...
        "quoteRu": "Эта работа, начатая Моисеем, который записал историю Творения и Закон Божий, совершалась на протяжении долгих шестнадцати столетий, пока наконец не была завершена Иоанном, записавшим величайшие истины Евангелия.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Описание этого события очевидцами вторит Божьим словам, записанным пророком Иоилем за двадцать пять столетий до их исполнения: «Солнце превратится во тьму и луна — в кровь, прежде нежели наступит день Господень, великий и страшный» (Иоиля 2:31).",
        "enKey": null,
        "asWritten": "genuinely-open",
        "weakened": "well-supported",
        "gap": 2,
    ...
    "claims": [
      {
        ...
        "quoteRu": "В какие-нибудь шесть минут погибло около 60 тысяч человек.",
        "enKey": "sixty thousand persons",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Как потом установили, в тот роковой день погибло около 90 тысяч человек.",
        "enKey": "ninety thousand persons",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Из других необыкновенных происшествий, случившихся во время катастрофы в Лиссабоне, можно отметить уничтоженную стихией новую набережную, сделанную из чистого мрамора. Ее сооружение обошлось в колоссальную сумму денег. В надежде укрыться от падающих обломков там собралось очень много людей, но внезапно вся набережная погрузилась в море, и ни один из погибших не показался на его поверхности».",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "Слепое упрямство иудейских вождей и отвратительные преступления, совершающиеся за стенами осажденного города, вызывали ужас и негодование римлян, и наконец Тит решил штурмом взять храм и, конечно, сделать все возможное, чтобы спасти его от разрушения. Но на его приказы никто не обращал внимания.",
        "enKey": null,
        "asWritten": "genuinely-open",
        "weakened": "genuinely-open",
        "gap": 0,
      ...
      },
      {
        ...
        "quoteRu": "Тит в сопровождении своих полководцев и легионеров поспешил к этому месту и приказал солдатам тушить пожар. Но на его слова никто не обращал внимания. В ярости воины швыряли горящие головни в комнаты, примыкающие к храму, а потом убивали укрывшихся в его стенах.",
        "enKey": null,
        "asWritten": "genuinely-open",
        "weakened": "genuinely-open",
        "gap": 0,
      ...
      },
      {
        ...
        "quoteRu": "«Тит был не в состоянии сдержать ярость солдат. Войдя в храм со своими офицерами, чтобы осмотреть внутренность святого места, он был поражен его великолепием, и так как пожар не достиг еще этого места, он выскочил наружу и старался убедить солдат потушить пожар.",
        "enKey": null,
        "asWritten": "genuinely-open",
        "weakened": "genuinely-open",
        "gap": 0,
  ...
  },
  {
    ...
    "claims": [
      ...
      },
      {
        ...
        "quoteRu": "В этих темных подземельях последователи Христа хоронили своих умерших, и когда на них падало подозрение и их объявляли вне закона, они находили здесь для себя приют.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
      ...
      },
      {
        ...
        "quoteRu": "Язычники предвидели, что если Евангелие победит, то идольские храмы и жертвенники будут уничтожены, поэтому они сплотили свои ряды и объявили христианам войну.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
      ...
      },
      {
        ...
        "quoteRu": "Учение о религиозной свободе назвали ересью; его сторонников ненавидели и изгоняли отовсюду.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
    ...
    "claims": [
      {
        ...
        "quoteRu": "Изуродованные тела миллионов мучеников взывали к Богу об отмщении этой отступнической державе.",
        "enKey": "millions",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
    ...
    "claims": [
      {
        ...
        "quoteRu": "Вынужденные совершать богослужения в лесах и горах, они и здесь преследовались солдатами, и многие из них погибли. Позже был издан указ сжигать на кострах тех, кто не исповедует римскую веру.",
        "enKey": "all who departed from the Romish worship should be burned",
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
        "kind": "fact",
      ...
      },
      {
        ...
        "quoteRu": "Его благочестивая мать, которая считала образование и «страх Господень» самым драгоценным сокровищем, стремилась всеми силами приобрести это наследие для своего сына.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "genuinely-open",
        "gap": 1,
      ...
      },
      {
        ...
        "quoteRu": "Гус отправился в Прагу в сопровождении матери; бедная вдова ничего не могла дать своему сыну, но, приблизившись к великому городу, она склонила колени и рядом с осиротевшим юношей умоляла Небесного Отца излить на него Свои благословения.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "genuinely-open",
        "gap": 1,
      ...
      },
      {
        ...
        "quoteRu": "Начав с открытого выступления против главенства папы, они вскоре вынуждены были изменить свои методы из-за преследований, последовавших со стороны властей.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "well-supported",
        "gap": 3,
      ...
      },
      {
        ...
        "quoteRu": "Это была проповедь, обратившая на себя внимание людей всех сословий. Целые толпы народа стекались посмотреть на эти картины.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
      ...
      },
      {
        ...
        "quoteRu": "В Праге поднялось большое волнение, и чужестранцы сочли за благо удалиться.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "n/a",
        "gap": null,
      ...
      },
      {
        ...
        "quoteRu": "Эти картины произвели глубокое впечатление на Гуса и побудили его с еще большим усердием изучать Библию и сочинения Уиклифа.",
        "enKey": null,
        "asWritten": "improbable",
        "weakened": "probable",
        "gap": 2,
