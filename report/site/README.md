...
Этап 3 (из 4): все разделы собраны — главная, семь звеньев цепи, «Спорные вопросы»,
«Карта книги», «Все утверждения» (таблица 4443 с историей вердикта и deep-link-фильтрами)
и «Как проверяли» (метод, беспристрастность, хартия, FAQ, инструменты, данные, автор,
лицензия, глоссарий). Осталось: финальный аудит (a11y, EN-сверка, Lighthouse, чистая
сборка) и инструкция деплоя.
